...
| **ID** | **Requisito** | **Fuente** | **Criterio de verificabilidad** |
| --- | --- | --- | --- |
| RF-01 | El   sistema deberá medir la temperatura ambiental mediante el BME280. | Propuesta   del proyecto | Se   realizará una medición y se comparará con un instrumento de referencia,   verificando que el valor obtenido se encuentre dentro del error establecido. |
| RF-02 | El   sistema deberá medir la humedad relativa mediante el BME280. | Propuesta   del proyecto | Se   comparará la medición con un instrumento de referencia bajo las mismas   condiciones ambientales. |
| RF-03 | El   sistema deberá medir la presión atmosférica mediante el BME280. | Propuesta   del proyecto | Se   verificará que el sistema obtenga y registre un valor de presión en las   unidades definidas. |
| RF-04 | El   sistema deberá medir la intensidad de radiación UV mediante el sensor   GUVA-S12SD. | Retroalimentación   del profesor / propuesta modificada | Se   expondrá el sensor a diferentes niveles de radiación UV y se verificará una   variación correspondiente en su lectura. |
| RF-05 | El   sistema deberá detectar la presencia de lluvia mediante el sensor basado en   LM393. | Retroalimentación   del profesor / propuesta modificada | Se   aplicará agua sobre el sensor y se verificará el cambio de la salida respecto   a una condición seca. |
| RF-06 | El   sistema deberá medir la velocidad del viento mediante el anemómetro   ZTS3000FSJT. | Cambio   de diseño / disponibilidad y costo | Se   aplicarán diferentes condiciones de flujo de aire y se verificará que la   salida del sensor cambie de acuerdo con la velocidad del viento. |
| RF-07 | El   sistema deberá adquirir las variables ambientales en intervalos de tiempo   configurables, utilizando inicialmente un intervalo de 15 minutos. | Propuesta   del proyecto | Se   verificará mediante registros de tiempo que las adquisiciones se produzcan en   los intervalos establecidos. |
| RF-08 | El   sistema deberá mantener la fecha y hora de las mediciones mediante un módulo   RTC. | Retroalimentación   del profesor / propuesta modificada | Se   comparará la fecha y hora registrada por el sistema con la hora de   referencia. |
| RF-09 | El   sistema deberá utilizar la señal de interrupción del RTC para iniciar un   ciclo de adquisición. | Diseño   del sistema | Se   observará que el sistema permanezca en bajo consumo y se active cuando ocurra   la alarma programada del RTC. |
| RF-10 | El   sistema deberá almacenar persistentemente las mediciones en una memoria   microSD. | Retroalimentación   del profesor | Se   verificará la creación y actualización del archivo de datos y la conservación   de registros después de reiniciar o interrumpir la alimentación. |
| RF-11 | Cada   registro almacenado deberá incluir la fecha y hora asociadas a la medición. | Retroalimentación   del profesor / diseño | Se   inspeccionará el archivo almacenado y se comprobará que cada registro   contenga una marca temporal válida. |
| RF-12 | El   sistema deberá calcular estadísticas de las variables ambientales   registradas. | Propuesta   del proyecto | Se   compararán los resultados calculados por el sistema con los resultados   obtenidos externamente a partir del mismo conjunto de datos. |
| RF-13 | El   sistema deberá obtener como mínimo valores promedio, máximo y mínimo de las   variables medidas. | Propuesta   del proyecto | Se   suministrará un conjunto conocido de datos y se verificará que los resultados   coincidan con los cálculos de referencia. |
| RF-14 | El   sistema deberá obtener varianza y desviación estándar de las variables para   los períodos definidos. | Propuesta   del proyecto | Se   utilizará un conjunto de datos conocido y se compararán los resultados del   sistema con un cálculo de referencia. |
| RF-15 | El   sistema deberá transmitir los datos hacia una plataforma IoT. | Retroalimentación   del profesor / propuesta modificada | Se   generará una medición y se verificará su recepción en la plataforma IoT. |
| RF-16 | La   plataforma IoT deberá permitir visualizar las variables registradas mediante   elementos gráficos. | Propuesta   modificada | Se   comprobará la actualización de las gráficas o indicadores después de recibir   nuevos datos. |
| RF-17 | El   sistema deberá almacenar localmente los datos cuando la comunicación con la   plataforma IoT no esté disponible. | Diseño   / robustez del sistema | Se   desconectará la comunicación, se generarán mediciones y posteriormente se   verificará que los datos permanezcan en la microSD. |
| RF-18 | El   sistema deberá regresar al estado de bajo consumo después de finalizar un   ciclo de adquisición. | Objetivo   de bajo consumo / diseño | Se   medirá el consumo o se observará el estado de operación del sistema después   de finalizar el ciclo. ## |

## **2.2 Requisitos no funcionales**

| **ID** | **Requisito** | **Fuente** | **Criterio de verificabilidad** |
| --- | --- | --- | --- |
| RNF-01 | El   sistema deberá utilizar alimentación basada en energía solar y almacenamiento   en baterías. | Retroalimentación   del profesor / propuesta | Se   demostrará el funcionamiento del sistema mediante el subsistema solar y la   batería. |
| RNF-02 | El   sistema deberá minimizar el consumo energético durante los períodos en los   que no se estén realizando mediciones. | Objetivo   del proyecto | Se   medirá el consumo en reposo y durante los principales estados de operación. |
| RNF-03 | Las   señales analógicas deberán encontrarse dentro del rango admisible por las   entradas del microcontrolador. | Restricciones   eléctricas de los componentes | Se   medirán las tensiones máximas de las señales antes de conectarlas al ADC. |
| RNF-04 | La   salida de 0–5 V del anemómetro deberá ser acondicionada antes de conectarse   al ADC de 3.3 V. | Hoja   de datos del ZTS3000FSJT / diseño | Se   medirá la tensión de entrada al ADC y se comprobará que no supere el límite   establecido. |
| RNF-05 | El   sistema deberá conservar la información histórica ante reinicios o   interrupciones temporales de alimentación. | Retroalimentación   del profesor | Se   interrumpirá la alimentación y posteriormente se verificará la integridad de   los registros almacenados. |
| RNF-06 | El   sistema deberá permitir identificar el estado de funcionamiento de sus   principales subsistemas. | Diseño   del sistema | Se   verificará mediante indicadores, registros o mensajes de diagnóstico. |
| RNF-07 | Los   datos almacenados deberán utilizar un formato que facilite su posterior   análisis. | Diseño   del sistema | Se   verificará que los archivos puedan ser importados y procesados mediante una   herramienta externa como Python o Excel. |
| RNF-08 | El   sistema deberá poder funcionar sin una conexión permanente con la plataforma   IoT. | Requisito   de operación remota / robustez | Se   desconectará la red y se verificará que la adquisición y almacenamiento local   continúen. |
| RNF-9 | Los   componentes deberán operar dentro de sus rangos de alimentación   especificados. | Hojas   de datos | Se   medirán las tensiones de alimentación durante el funcionamiento. |
| RNF-10 | El   diseño deberá permitir realizar mantenimiento o reemplazo de sensores y   almacenamiento sin modificar completamente el sistema. | Diseño   del sistema | Se   inspeccionará físicamente el montaje y las conexiones. ## |

## **2.3 Requisitos ambientales**

| **ID** | **Requisito ambiental** | **Fuente** | **Criterio de verificabilidad |
| --- | --- | --- | --- |
| RA-01 | El   BME280 deberá instalarse dentro de una garita meteorológica que permita   circulación de aire y reduzca la exposición directa al Sol y a la lluvia. | Retroalimentación   del profesor | Inspección   física del montaje. |
| RA-02 | Los   sensores expuestos deberán contar con protección física frente a lluvia   directa cuando su principio de funcionamiento no requiera exposición al agua. | Condiciones   de operación / diseño | Inspección   del montaje. |
| RA-03 | El   sistema deberá poder operar dentro de los rangos de temperatura especificados   por los fabricantes de los componentes. | Hojas   de datos | Comparación   entre las condiciones de operación y los rangos especificados. |
| RA-04 | Los   componentes electrónicos principales deberán estar protegidos frente a   humedad y contacto accidental con agua. | Condiciones   ambientales / diseño | Inspección   del encapsulado y montaje. |
| RA-05 | El   sistema de generación solar deberá estar ubicado de manera que pueda recibir   radiación solar suficiente para realizar la recarga. | Diseño   energético | Prueba   de generación y medición de tensión/corriente del sistema solar. |
| RA-06 | El   montaje deberá proporcionar estabilidad mecánica suficiente para mantener la   orientación y posición de los sensores. | Condiciones   de instalación | Inspección   física y prueba de estabilidad. |
| RA-07 | El   anemómetro deberá instalarse de forma que tenga exposición suficiente al   flujo de aire y no quede obstruido por elementos cercanos. | Principio   de medición del sensor | Inspección   del montaje y prueba de respuesta al flujo de aire. ## |

## **2.4 Requisitos normativos y de seguridad**

| **ID** | **Requisito normativo / de seguridad** | **Fuente** | **Criterio de verificabilidad |
| --- | --- | --- | --- |
| RN-01 | El   sistema de alimentación deberá diseñarse evitando conexiones directas o   condiciones de carga que puedan generar riesgos para las baterías. | Seguridad   eléctrica / fabricante de baterías | Inspección   del circuito de carga y verificación del uso de un controlador adecuado. |
| RN-02 | El   paquete de baterías deberá contar con un sistema de carga y protección   compatible con la configuración utilizada. | Seguridad   de baterías / fabricante | Inspección   del cargador/BMS y verificación de sus especificaciones. |
| RN-03 | Las   conexiones eléctricas deberán estar aisladas y protegidas frente a   cortocircuitos accidentales. | Seguridad   eléctrica / RETIE como referencia aplicable | Inspección   física y prueba de continuidad/aislamiento cuando corresponda. |
| RN-04 | Los   conductores y conectores deberán ser adecuados para las corrientes y   tensiones presentes en el sistema. | Seguridad   eléctrica / RETIE | Revisión   de especificaciones y calibre/capacidad de los conductores. |
| RN-05 | El   sistema no deberá presentar partes eléctricas expuestas que puedan producir   contacto accidental durante la operación normal. | Seguridad   eléctrica | Inspección   física del prototipo. |
| RN-06 | En   caso de utilizar conectividad inalámbrica mediante Pico W, se deberá utilizar   la interfaz inalámbrica integrada dentro de las condiciones de operación   permitidas para el dispositivo. | Diseño   / regulación de espectro | Verificación   del módulo utilizado y configuración de operación. # |
...
| RF-17 | PR-03,   PR-07 |
| RF-18 | PR-02,   PR-08 |
| RNF-01 | Inspección   del prototipo |
| RNF-02 | PR-09 |
| RNF-03 | PR-08 |
| RNF-04 | PR-10 |
| RNF-05 | PR-10 |
| RNF-06 | PR-04 |
| RNF-07 | PR-01,   PR-07, PR-08 |
| RNF-08 | PR-03 |
| RNF-09 | PR-07 |
| RNF-10 | PR-08,   PR-09, PR-10 |
| RNF-11 | Inspección   del prototipo |
| RA-01 | PR-11 |
| RA-02 | PR-11 |
| RA-03 | PR-11 |
| RA-04 | PR-11 |
...
| RA-06 | PR-11 |
| RA-07 | PR-11 |
| RN-01 | PR-09   / inspección |
| RN-02 | PR-09   / inspección |
| RN-03 | Inspección |
| RN-04 | Inspección |
| RN-05 | Inspección |
| RN-06 | Inspección   / configuración |
